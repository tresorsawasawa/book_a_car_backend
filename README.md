...
```bash
git clone https://github.com/tresorsawasawa/book_a_car_frontend.git
```
### Move into the cloned directory with

  ```bash
  cd book_a_car_frontend
  ```
...
Feel free to check the [issues page](https://github.com/tresorsawasawa/book_a_car_frontend/issues).
